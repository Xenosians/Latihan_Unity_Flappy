...
{   
    ...
    private void Start(){
        ...
        SaveScript save2 = new SaveScript();
        string Ss2 = GDCUtils.ConvertObjectToJsonString<SaveScript>(save2);
        save2.time = GetTime();
        SaveScript save3 = new SaveScript();
        string Ss3 = GDCUtils.ConvertObjectToJsonString<SaveScript>(save3);
        save3.thisIsInt = GetHighscore();
